...
I had some trouble adding the children properties into variable terah because I tried to just call the property and had it set to the children's name as such: terah.children.carson = "Carson". That didn't work because I forgot to include the property "name" then set "Carson" as it's value. 

How difficult was it to add and delete properties outside of the object itself?
It was very easy! Not only to add and delete but also changing the values.

What did you learn about manipulating objects in this challenge?
I learned to use the method delete and how I can easily manipulate properties outside of the object! 
*/
// __________________________________________
